...
namespace Mageplaza\PdfInvoice\Controller\Adminhtml\Shipment;
...
class PrintAction extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            $this->helperData->printPdf(Type::SHIPMENT, $id);
        } catch (Exception $e) {
            $this->messageManager->addError($e->getMessage());
        }

        return $this->_redirect('adminhtml/order_shipment/view', ['shipment_id' => $id]);
    }
}
